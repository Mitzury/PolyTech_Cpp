...
<blockquote>Отметьте варианты реализации шаблонной функции, для которых компилятор не будет выдавать ошибок в приведенном фрагменте:</blockquote>
<blockquote><em>double d = 5.5; </em><br /><em> f(&amp;d); </em><br /><em> f(d);</em> <br /> &nbsp; <br />Выберите один или несколько ответов:</blockquote>
<ul>
...
<blockquote><br /> <em>class a {}; </em><br /><em> class b : public a {}; </em><br /><em> viod main() { </em><br /><em> b b;</em><br /><em> }</em></blockquote>
<blockquote><br /> какие конструкторы и в каком порядке вызываются? <br /> выберите один ответ:</blockquote>
<ul>
<li>a. b</li>
<li>b. b a</li>
<li>c. a b</li>
...
<blockquote><br /> деструктор <br /> выберите один или несколько ответов:</blockquote>
<ul>
<li>a. программист должен обязательно явно реализовать в каждом классе</li>
...
<blockquote><br /> <em>class a { </em><br /><em> int m_a; </em><br /><em> public: </em><br /><em> a(int a); </em><br /><em> };</em></blockquote>
<blockquote><br /> отметьте корректные варианты <br /> выберите один или несколько ответов:</blockquote>
<ul>
<li>a. a::a(int a) { m_a = a; }</li>
<li>b. a::a(int a) : m_a(a) { }</li>
</ul>
<p><strong>Вопрос 34:</strong></p>
<blockquote><br /> default конструктор <br /> выберите один или несколько ответов:</blockquote>
<ul>
...
<blockquote><br /> <em>class a { </em><br /><em> int m_a; </em><br /><em> public: </em><br /><em> void f(); </em><br /><em> };</em></blockquote>
<blockquote><br /> отметьте корректные варианты <br /> выберите один или несколько ответов:</blockquote>
<ul>
...
<blockquote>отметьте корректные варианты: <br /> выберите один или несколько ответов:</blockquote>
<ul>
...
<blockquote>при объявлении шаблона можно указать в качестве параметров шаблона: <br /> выберите один или несколько ответов:</blockquote>
<ul>
...
<blockquote><br /> <em>a.h</em></blockquote>
<blockquote><em> class a { </em><br /><em> int m_a; </em><br /><em> public: </em><br /><em> void f(); </em><br /><em> };</em></blockquote>
<blockquote><br /> отметьте корректные варианты <br /> выберите один или несколько ответов:</blockquote>
<ul>
...
<blockquote>ключевые слова с++, которые относятся к механизму обработки исключений <br /> выберите один или несколько ответов:</blockquote>
<ul>
<li>a. throw</li>
<li>b. catch</li>
<li>c. try</li>
...
<blockquote><em>class a { virtual void f(); }; </em><br /><em> class b : public a { &nbsp;}; </em><br /><em> &nbsp; </em><br /><em> int main() { </em><br /><em> a* pa = new b; </em><br /><em> bool b = typeid(*pa).before(typeid(a)); //? </em><br /><em> } </em><br /><em> &nbsp;</em> <br /> значение переменной "b&rdquo;: <br /> выберите один ответ:</blockquote>
<ul>
<li>a. false</li>
<li>b. true</li>
</ul>
<p><strong>Вопрос 41:</strong></p>
<blockquote><br /> порядок инициализации переменных класса <br /> выберите один ответ:</blockquote>
<ul>
...
<blockquote><em>class a { </em><br /><em> ... </em><br /><em> public: void f(); </em><br /><em> ... </em><br /><em> }; </em><br /><em> vector &lt;a*&gt; v; </em><br /><em> //формирование элементов вектора </em><br /><em> vector &lt;a*&gt;::iterator it = v.begin();</em> <br /> &nbsp; <br /> отметьте корректные варианты вызова метода a::f() <br /> выберите один или несколько ответов:</blockquote>
<ul>
<li>a. (*it)-&gt;f();</li>
<li>b. (*it).f();</li>
<li>c. (**it).f();</li>
...
<blockquote><br /> <em>a.h </em><br /><em> class a { </em><br /><em> ... </em><br /><em> public: </em><br /><em> a(int); </em><br /><em> };</em></blockquote>
<blockquote><br /> отметьте корректные варианты <br /> выберите один или несколько ответов:</blockquote>
<ul>
<li>a. a* pa = new a();</li>
<li>b. a a;</li>
...
<blockquote><br /> шаблонная функция может быть перегружена <br /> выберите один ответ:</blockquote>
<ul>
<li>a. да</li>
<li>b. нет</li>
</ul>
<p><strong>Вопрос 45:</strong></p>
<blockquote><br /> <em>class a {}; </em><br /><em> class b : public a {}; </em><br /><em> &nbsp; </em><br /><em> void f1(const a&amp;, const a&amp;); </em><br /><em> void f2(const b&amp;, const b&amp;);</em> <br /> &nbsp; <br /> отметьте корректные варианты <br /> выберите один или несколько ответов:</blockquote>
<ul>
...
<blockquote><br /> <em>int ar[5] = {1, 2, 3, 4, 5}; </em><br /><em> vector&lt;int&gt; v;</em> <br /> &nbsp; <br /> отметьте корректные варианты: <br /> выберите один или несколько ответов:</blockquote>
<ul>
...
<blockquote><br /><br /> дано <br /> a a1, a2, a3;</blockquote>
<blockquote><br /> отметьте примеры, в которых оператор можно перегрузить только глобальной функцией <br /> выберите один или несколько ответов:</blockquote>
<ul>
<li>a. a3 = -a1;</li>
<li>b. a3 += a2;</li>
<li>c. a3 = 1 + a2;</li>
...
<blockquote><br /> методы класса могут быть <br /> выберите один или несколько ответов:</blockquote>
<ul>
<li>a. private</li>
<li>b. public</li>
<li>c. protected</li>
...
<blockquote><br /> выберите один или несколько ответов:</blockquote>
<ul>
...
<blockquote><br /> <em>class a { void f(); };</em> <br /> &nbsp; <br /> тип указателя this в методе f() выберите один или несколько ответов:</blockquote>
<ul>
<li>a. const a*</li>
<li>b. a*</li>
<li>c. a* const</li>
...
<blockquote><br /> понятия, связанные с rtti: <br /> выберите один или несколько ответов:</blockquote>
<ul>
...
<blockquote><br /> <em>class a {</em><br /><em> void f(); </em><br /><em> };</em> <br /> &nbsp; <br /> тип указателя this в методе f() <br /> выберите один или несколько ответов:</blockquote>
<ul>
<li>a. const a*</li>
<li>b. a*</li>
<li>c. a* const</li>
...
<blockquote><br /> какие из утверждений верны? <br /> выберите один или несколько ответов:</blockquote>
<ul>
...
<blockquote><br /> <em>vector&lt;vector&lt;int&gt;&gt; v(10, vector&lt;int&gt;(10,1));</em></blockquote>
<blockquote><br /> отметьте корректные варианты получения значений элементов <br /> выберите один или несколько ответов:</blockquote>
<ul>
...
<blockquote><br /> объекты класса &nbsp; <strong>type_info</strong> &nbsp; можно: <br /> выберите один или несколько ответов:</blockquote>
<ul>
<li>a. копировать</li>
...
<blockquote><br /> в каких вариантах компилятор не выдаст ошибку? <br /> выберите один или несколько ответов:</blockquote>
<ul>
...
<blockquote><br /> <em>class a { }; a a; void func() { }</em></blockquote>
<blockquote><br /> когда будет вызван деструктор? <br /> выберите один ответ:</blockquote>
<ul>
...
<blockquote><br /> когда вызывается деструктор для объекта-исключения? <br /> выберите один или несколько ответов:</blockquote>
<ul>
...
<blockquote><br /> <em>class a { ... }; </em><br /><em> a a; </em><br /><em> void func() </em><br /><em> { </em><br /><em> &hellip; </em><br /><em> }</em></blockquote>
<blockquote><br /> когда будет вызван деструктор? <br /> выберите один ответ:</blockquote>
<ul>
<li>a. при завершении приложения</li>
<li>b. никогда</li>
...
<blockquote><br /> в контейнерах stl <br /> выберите один ответ:</blockquote>
<ul>
...
<blockquote><br /> <em>class a { </em><br /><em> int x; </em><br /><em> protected: </em><br /><em> int y; </em><br /><em> public: </em><br /><em> void f(); </em><br /><em> &hellip; </em><br /><em> }; </em><br /><em> class b : public a {&hellip;};</em></blockquote>
<blockquote><br /> отметьте корректные варианты <br /> выберите один или несколько ответов:</blockquote>
<ul>
...
<blockquote><br /> <em>class a { </em><br /><em> int m_a; </em><br /><em> public: </em><br /><em> a operator=(const a&amp;); </em><br /><em> };</em></blockquote>
<blockquote><br /> в каких примерах можно использовать реализованный оператор присваивания <br /> выберите один или несколько ответов:</blockquote>
<ul>
...
<blockquote><br /> какой из операторов присваивания &nbsp;более эффективен? <br /> выберите один ответ:</blockquote>
<ul>
...
<blockquote><br /> <em>class a { </em><br /><em> int m_a; </em><br /><em> public: </em><br /><em> a(int &nbsp;= 0); </em><br /><em> }; </em><br /><em> class b { </em><br /><em> int m_b; </em><br /><em> a m_a; </em><br /><em> public: </em><br /><em> b(const a&amp;, int b); </em><br /><em> };</em></blockquote>
<blockquote><br /> отметьте корректные и эффективные варианты инициализации встроенного объекта <br /> выберите один или несколько ответов:</blockquote>
<ul>
...
<blockquote><br /> в качестве базового контейнера для<strong> std::priority_queue</strong> можно использовать: <br /> выберите один или несколько ответов:</blockquote>
<ul>
<li>a. std::list</li>
<li>b. std::deque</li>
<li>c. std::vector</li>
...
<blockquote><br /> отметьте правильные варианты создания объектов <br /> выберите один или несколько ответов:</blockquote>
<ul>
...
<blockquote><br /> диапазон изменения данных от (-2) до (+1). <br /> какое из битовых полей удовлетворяет условию? <br /> выберите один ответ:</blockquote>
<ul>
...
<blockquote><br /><br /> выберите один или несколько ответов:</blockquote>
<ul>
...
<blockquote><br /> <em>class a { </em><br /><em> &hellip; </em><br /><em> void f() const; </em><br /><em> };</em></blockquote>
<blockquote><br /> отметьте корректные варианты <br /> выберите один или несколько ответов:</blockquote>
<ul>
...
<blockquote><br /> <em>vector&lt;int&gt; v(10,1); </em><br /><em> vector&lt;int&gt;::iterator it = v.begin();</em> <br /> &nbsp; <br /> отметьте корректные варианты получения значений элементов <br /> выберите один или несколько ответов:</blockquote>
<ul>
<li>a. int x = *(it + 5);</li>
<li>b. int x = *it;</li>
<li>c. int x = *(v.end());</li>
...
<blockquote><br /> <em>class a { ... &nbsp;virtual void f(); ... }; </em><br /><em> class b : public a { ... }; </em><br /><em> &nbsp; </em><br /><em> int main() { </em><br /><em> a* pa = new b; </em><br /><em> bool b = typeid(*pa).before(typeid(b)); </em><br /><em> } </em><br /><em> &nbsp;</em> <br /> значение переменной "b&rdquo;: <br /> выберите один ответ:</blockquote>
<ul>
<li>a. true</li>
<li>b. false</li>
</ul>
<p><strong>Вопрос 78:</strong></p>
<blockquote><br /> <em>a.h </em><br /><em> class a { ... </em><br /><em> public: </em><br /><em> explicit a(int = 0); </em><br /><em> };</em></blockquote>
<blockquote><br /> отметьте корректные варианты <br /> выберите один или несколько ответов:</blockquote>
<ul>
...
<blockquote><br /> дано: <br /> class a { ... }; <br /> a a1, a2; <br /> для выражения a1 + &nbsp;a2: <br /> выберите один или несколько ответов:</blockquote>
<ul>
...
<blockquote><br /><br /> <em>class a { &lt;простой&gt; }; </em><br /><em> class b: &nbsp;public a { &lt;сложный&gt; };</em> <br /> &nbsp; <br /> отметьте корректные утверждения <br /> выберите один или несколько ответов:</blockquote>
<ul>
...
<blockquote><br /> какие из спецификаторов доступа позволяет вызывать методы базового класса в методах производного класса <br /> выберите один или несколько ответов:</blockquote>
<ul>
<li>a. private</li>
<li>b. protected</li>
<li>c. public</li>
...
<blockquote><br /> <em>class out { </em><br /><em> class in { ... </em><br /><em> in(); </em><br /><em> }; </em><br /><em> ... </em><br /><em> out(); </em><br /><em> };</em></blockquote>
<blockquote><br /> отметьте корректные варианты <br /> выберите один или несколько ответов:</blockquote>
<ul>
<li>a. out::out() { ... }</li>
<li>b. in::in() { ... }</li>
...
<blockquote><br /> метод <strong>push_front()</strong> реализован для <br /> выберите один или несколько ответов:</blockquote>
<ul>
<li>a. deque</li>
<li>b. vector</li>
<li>c. stack</li>
...
<blockquote><br /> <em>vector&lt;int&gt; v; </em><br /><em> v.reserve(10); </em><br /><em> v.push_back(33); </em><br /><em> size_t n = v.size();</em> <br /><br /><br /> значение переменной n?</blockquote>
<p><strong>Вопрос 86:</strong></p>
<blockquote><br /> <em>class x { </em><br /><em> int m_x; </em><br /><em> void fx(y&amp; y); </em><br /><em> friend void y::fy1(x&amp; x); </em><br /><em> }; </em><br /><em> class y{ </em><br /><em> int m_y; </em><br /><em> void fy1(x&amp; x); </em><br /><em> void fy2(x&amp; x); </em><br /><em> };</em></blockquote>
<blockquote><br /> отметьте корректные варианты <br /> выберите один или несколько ответов:</blockquote>
<ul>
...
<blockquote><br /> отметьте корректные варианты: выберете один или несколько ответов:</blockquote>
<ul>
<li>a) &nbsp;try{ &nbsp;... &nbsp;} &nbsp;catch(...) { &nbsp; &lt;обработка всех типов исключительных ситуаций, &nbsp; кроме целочисленного исключения&gt; &nbsp;} &nbsp;catch (int n) { &nbsp; &lt;обработка целочисленного исключения&gt; &nbsp;}</li>
...
<blockquote>отличие классов от структур языка си выберете один или несколько ответов:</blockquote>
<ul>
<li>a) структура си может содержать как данные, так и методы</li>
<li>b) класс может содержать как данные, так и методы</li>
<li>c) класс может содержать только методы</li>
...
<blockquote>отметьте корректные высказывания:</blockquote>
<ul>
<li>a) операции вставки/удаления значений в вписок осуществляются &nbsp;эффективнее чем в вектор</li>
<li>b) данные в списке располагаются последовательно в памяти</li>
</ul>
<p><strong>Вопрос 91:</strong></p>
<blockquote>куда происходит передача управления при выполнении оператора throw? выберете один или несколько ответов:</blockquote>
<ul>
<li>a) на открывающую фигурную скобку обработчика catch(int)</li>
<li>b) на закрывающую фигурную скобку блока, в котором находится &nbsp; &nbsp;оператор throw</li>
<li>c) на закрывающую фигурную скобку функции, в которой находится оператор throw</li>
...
<blockquote><br /> куда происходит передача управления при выполнении оператора throw 1? выберете один или несколько ответов:</blockquote>
<ul>
<li>a) на открывающую фигурную скобку обработчика catch(int)</li>
<li>b) на закрывающую фигурную скобку блока, в котором находится &nbsp; &nbsp;оператор throw</li>
...
<blockquote><br /> <em>class a { &nbsp;int m_a; public: &nbsp;a(int); &nbsp;void f(); }; class b public a { &nbsp;int m_b; public: &nbsp;b(int,int); &nbsp;virtual void f(); }; class c public b { &nbsp;int m_c; public: &nbsp;c(int,int,int); };</em></blockquote>
<blockquote><br /> для каких классов компилятор сформирует таблицу виртуальных функций выберете один или несколько ответов:</blockquote>
<ul>
<li>a) c</li>
<li>b) a</li>
<li>c) b</li>
