...
// Обмен значениями переменных x1 и y1
	int x1 = 1, y1 = -1;
	EXCHANGE(x1, y1);  // x1=-1, y1=1

	// Обмен значениями переменных x2 и y2
	int x2 = 100, y2 = -100;
	...
	printf("x1=%d, y1=%d\n", x1, y1);
	printf("x2=%d, y2=%d\n", x2, y2);
	//Этот макрос использует временную переменную temp, чтобы обменять значения X и Y. 
// Обратите внимание, что этот макрос безопасен при обмене переменными любого целочисленного типа.
