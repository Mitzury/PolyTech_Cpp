...
// Строка становится "0000101"
// Итерация 2:
// result = (0 << 1) + (0 - '0') = 0 + 0 = 0
// Строка становится "000101"
// Итерация 5:
// result = (0 << 1) + (0 - '0') = 0 + 0 = 0
// Строка становится "101"
// Итерация 6:
// result = (0 << 1) + (1 - '0') = 0 + 1 = 1
// Строка становится "01"
// Итерация 7:  влево на 1 разряд (эквивалентно умножению на 2)
// result = (1 << 1) + (0 - '0') = 2 + 0 = 2
// Строка становится "1"
// Итерация 8: влево на 1 разряд (эквивалентно умножению на 2)
...
int main() {
...

	{
		...
		int num = "000000101"_b;  // Конвертация двоичной строки в число
